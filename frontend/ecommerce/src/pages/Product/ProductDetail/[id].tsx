            ...
            <div className="w-[60%] p-3">
              ...
              <div className='flex'>
                ...
                <div className="border-[#cccccc] border-2">
                  <button className="bg-[#f3f3f3] px-3 py-2" onClick={() => setQuantity(quantity - 1)}>&mdash;</button>
                  <input className="w-28 text-center focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" type="number" value={quantity}/>
                  <button className="bg-[#f3f3f3] px-3 py-2" onClick={() => setQuantity(quantity + 1)}>&#xff0b;</button>
                </div>
