    ...
    <div className="inline-flex px-5 py-3 bg-[rgba(20,177,231,.1)]">
      <div className="w-[40%]">
        ...
        <div className="w-full inline-flex justify-center">
          <a href="https://www.facebook.com/pdcthanh112/">
            <Image src={FacebookIcon} alt="Facebook icon" style={{width:"30rem", height:"auto"}} className="mx-2" />
          </a>
          <a href="https://www.linkedin.com/in/pdcthanh112dev/">
            <Image src={LinkedInIcon} alt="LinkedIn icon" style={{width:"30rem", height:"auto"}} className="mx-2" />
          </a>
          <a href="https://www.linkedin.com/in/pdcthanh112dev/">
            <Image src={TwitterIcon} alt="Twitter icon" style={{width:"30rem", height:"auto"}} className="mx-2" />
          </a>
          <a href="https://www.linkedin.com/in/pdcthanh112dev/">
            <Image src={InstagramIcon} alt="Instagram icon" style={{width:"30rem", height:"auto"}} className="mx-2" />
          </a>
          <a href="https://www.linkedin.com/in/pdcthanh112dev/">
            <Image src={YoutubeIcon} alt="Youtube icon" style={{width:"30rem", height:"auto"}} className="mx-2" />
          </a>
          <a href="https://github.com/pdcthanh112/">
            <Image src={GitHubIcon} alt="Youtube icon" style={{width:"30rem", height:"auto"}} className="mx-2" />
          </a>
        </div>
      ...
      <div className="w-[30%]">
        <div className="flex py-2">
          <Image src={LocationIcon} alt="Location icon" style={{width:"24rem", height:"auto"}} />
          <TextStyle className="ml-2">285 CMT8 Street, Ward 12, District 10, Ho Chi Minh City</TextStyle>
        </div>
        <div className="flex py-2">
          <Image src={PhoneIcon} alt="Phone icon" style={{width:"24rem", height:"auto"}} />
          <TextStyle className="ml-2">0382-722-849</TextStyle>
        </div>
        <div className="flex py-2">
          <Image src={WebsiteIcon} alt="Website icon" style={{width:"24rem", height:"auto"}} />
          <TextStyle className="ml-2">mydream.com.vn</TextStyle>
        </div>
        <div className="flex py-2">
          <Image src={EmailIcon} alt="Email icon" style={{width:"24rem", height:"auto"}} />
